...
//     try{
//     const newEmp= new employeesModel({name:req.body.emp_name,email:req.body.emp_email,salary:5000})
//     await newEmp.save({runValidators:true})
//     }
//     catch(e){
...
const testRun=async()=>{
    const newUser= new Users({
        name:"Kanagu",
        age:120,
        email:"kanagu@gmail.com",
        address:{
            city:"Bangalore",
            state:"Karnataka"
        },
        neighbour:"6915e23b591053c9457826cf"
    })
    const userAdded=await newUser.save()
    console.log(userAdded)
//    const data= await Users.find({_id:"6915e27799630ab903edfd9f"}).populate("neighbour","name").populate("employee")
//    console.log(data)
}
testRun()